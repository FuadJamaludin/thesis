...
def get_electrical_data(years_elect):
    if years_elect == [2030]:
        ...
        return "C:/Users/work/pypsa_thesis/data/electrical/1_case_1_2040"
    elif years_elect == [2050]:
        return "C:/Users/work/pypsa_thesis/data/electrical/1_case_1_2050"
...
def hydrogen_constraints(n, snapshots):
    ...
    # total_production = total_h2_demand
    total_production = 3237109.458
...
link_buses = get_hydrogen_data(h2_scenario_demand, years)
...
# total_h2_demand = (sum(h2_demand['h2_demand'])) * 1e6  # 3.24 TWh/a = 3237109.458 MWh/a of H2 demand in BW
